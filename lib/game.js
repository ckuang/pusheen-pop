(function () {
  ...
  var Game = PuzzleBobble.Game = function (xDim, yDim) {
    ...
    this.baseball = new PuzzleBobble.Bubble(250, 720, false, this.uniqueId)
    this.uniqueId += 1
  };
  ...
  Game.prototype.moveFallingBubbles = function () {
    for (var i = 0; i < this.fallingBubbles.length; i++) {
      ...
      if (this.fallingBubbles[i].centerY > 800) {
  ...
  Game.prototype.resetBaseBall = function () {
    if (this.baseball.moving === false && this.baseball.centerY !== 720) {
